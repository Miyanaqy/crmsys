...
<SCRIPT language=javascript>
	...
	$(function(){
		...
		$.post(url, function(result){
			var linkmanId = ${model.linkman.link_id}
			$(result).each(function(){
				if(linkmanId == this.link_id){
					$("#linkmanId").append("<option value='"+this.link_id+"' selected>"+ this.link_name +"</option>");
				}else{
					$("#linkmanId").append("<option value='"+this.link_id+"'>"+ this.link_name +"</option>");
				}
			});
		}, "json");
	});
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
													 <select id="linkmanId" name="linkman.link_id">
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${visit.linkman.link_name }</TD>
													<TD>${visit.visit_address }</TD>

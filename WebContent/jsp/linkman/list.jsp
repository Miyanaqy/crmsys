										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${linkman.link_gender }</TD>
													<TD>${linkman.link_phone }</TD>
													<TD>${linkman.link_mobile }</TD>
													
													<TD>
													<a href="${pageContext.request.contextPath }/linkman_initUpdate.action?link_id=${linkman.link_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/linkman_delete?link_id=${linkman.link_id}" onclick="retrun window.confirm('你确定要删除该联系人吗？')">删除</a>
													</TD>
												</TR>
